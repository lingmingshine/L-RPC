...
public class LRpcMessageDecoder extends LengthFieldBasedFrameDecoder {
     ...
     */
    public LRpcMessageDecoder(int maxFrameLength, int lengthFieldOffset, int lengthFieldLength,
    ...
    private Object decodeFrame(ByteBuf in) {
        ...
        LRpcMessage rpcMessage = LRpcMessage.builder()
                .codec(codecType)
                .requestId(requestId)
        ...
        if (bodyLength > 0) {
            ...
            if (messageType == RpcConstants.REQUEST_TYPE) {
                LRpcRequest tmpValue = serializer.deserialize(bs, LRpcRequest.class);
                rpcMessage.setData(tmpValue);
            } else {
                LRpcResponse tmpValue = serializer.deserialize(bs, LRpcResponse.class);
                rpcMessage.setData(tmpValue);
            }
        }
        return rpcMessage;
